...
var ENTITY_ATTR_MAP = (_ENTITY_ATTR_MAP = {}, _defineProperty(_ENTITY_ATTR_MAP, _draftJsUtils.ENTITY_TYPE.LINK, { url: 'href', rel: 'rel', target: 'target', title: 'title', className: 'class' }), _defineProperty(_ENTITY_ATTR_MAP, _draftJsUtils.ENTITY_TYPE.IMAGE, { src: 'src', height: 'height', width: 'width', alt: 'alt', className: 'class', 'data-original-url': 'href' }), _defineProperty(_ENTITY_ATTR_MAP, IFRAME, {
  src: 'src',
  height: 'height',
  width: 'width',
  name: 'name',
    ...
    value: function renderBlockContent(block) {
      ...
      return entityPieces.map(function (_ref) {
        ...
        if (entityType != null && entityType === _draftJsUtils.ENTITY_TYPE.LINK) {
          ...
          return '<a href="' + _attrs.href + '" target="' + _attrs.target + '" class="uploaded-image"><img src="' + _attrs.src + '" alt="' + _attrs.alt + '" /></a>';
